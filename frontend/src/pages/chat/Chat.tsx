                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>CTM Secure ChatGPT</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Click here for instructions on how to use this Chatbot.</h2>
                            </Stack>
                        ) : (
